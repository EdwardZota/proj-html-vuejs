...
<template>
    <div>
        <div class="container">
            <h1>Key Features</h1>
            <p class="subtitle">Start working with <span class="colored"> Landrich</span> that can provide everything you
                need to generate <br> awareness, drive traffic, connect.</p>
            <div class="cards">
